...
describe("Unit Tests - Utilities", function () {
	...
	describe("utilities.sha256", function () {
	    var test = function (t) {
	        it(JSON.stringify(t.hashable) + " -> " + t.digest, function () {
	            assert.strictEqual(utils.sha256(t.hashable), t.digest, utils.sha256(t.hashable));
	        });
	    };
	    test({
	        hashable: [1, 2, 3],
	    ...
	    test({
	        ...
	        digest: "0x6784ad917a15153116e907702f10c14cb20b61a8f2f45260269b58474e2544d1"
	    });
	    test({
